...
public class Main {
    public static void main(String[] args) {
        try (
            ...
            System.err.println("Failed to connect to the server, please check the server address and port.");
        }
        catch (SocketTimeoutException e) {
            System.err.println("Connection to the server timed out. Please check your network connection and try again.");
        }
        catch (Exception e) {
