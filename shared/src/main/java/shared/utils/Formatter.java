...
public class Formatter {
  ...
  /**
   * Returns format (see {@link java.util.Formatter}) of {@link String} to print text with given
   * number of columns with given width.
   *
  ...
  public static String getColumnStringFormat(int numberOfColumns, int minColumnWidth) {
    ...
    for (int i = 0; i < numberOfColumns; i++) sb.append(columnFormat);
