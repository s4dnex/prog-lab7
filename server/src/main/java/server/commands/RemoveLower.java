...
public class RemoveLower extends Command {
  ...
  public Response execute(String[] args, Object obj) {
    ...
    if (amount > 1) return new Response(true, amount + " elements have been removed!");
    else if (amount == 1) return new Response(true, "1 element has been removed!");
    else return new Response(true, "No elements have been removed!");
  }
}
